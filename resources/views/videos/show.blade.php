            ...
            <div class="col-xl-8 col-lg-8">
                ...
                <div class="watch-info">
                    ...
                    <div class="watch-meta">
                        ...
                        <span>
                            {{ $video->published_at ? $video->published_at->diffForHumans() : 'Recently' }}
                        </span>
                ...
                <div class="channel-bar">
                    ...
                    <div class="channel-details">
                        ...
                        <p>
                            ...
                            •
                            {{ number_format($video->channel->subscriber_count) }}
                            subscribers
                ...
                <div class="watch-actions">
                    ...
                    @auth
                        ...
                        <form method="POST" action="{{ route('videos.like', $video->id) }}">
                            ...
                            <button type="submit" class="watch-action {{ $userLike?->type === 'dislike' ? 'active' : '' }}">
                                ...
                                {{ number_format($video->dislikes_count) }}
                    ...
                    @auth
                        ...
                        @if(Auth::id() !== $video->user_id)
                                ...
                                'type' => 'video',
                                'id' => $video->id
                            ]) }}" class="watch-action report-action">
